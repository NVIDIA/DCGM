...
DCGM_ENTRY_POINT(dcgmGetNvLinkLinkStatus,
                 ...
                 (dcgmHandle_t dcgmHandle, dcgmNvLinkStatus_v5 *linkStatus),
                 "({} {})",
                 dcgmHandle,
                 linkStatus)
...
DCGM_ENTRY_POINT(dcgmGetDeviceTopology,
                 ...
                 (dcgmHandle_t pDcgmHandle, unsigned int gpuId, dcgmDeviceTopology_v2 *deviceTopology),
                 "({} {} {})",
                 pDcgmHandle,
                 gpuId,
                 deviceTopology)
...
DCGM_ENTRY_POINT(dcgmGetGroupTopology,
                 ...
                 (dcgmHandle_t pDcgmHandle, dcgmGpuGrp_t groupId, dcgmGroupTopology_v2 *groupTopology),
                 "({} {} {})",
                 pDcgmHandle,
                 groupId,
                 groupTopology)
