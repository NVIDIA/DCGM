...
// Overrides
void MockDcgmSystem::Init(dcgmHandle_t handle)
{
    m_handle = handle;
}

dcgmReturn_t MockDcgmSystem::GetAllDevices(std::vector<unsigned int> &gpuIdList)
{
    gpuIdList.clear();
...
// Mocked methods
void MockDcgmSystem::AddMockedEntity(DcgmNs::MockDcgmEntity const &mockedEntity)
{
