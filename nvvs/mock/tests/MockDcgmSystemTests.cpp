...
class TestMockDcgmSystem : public MockDcgmSystem
{
public:
    using MockDcgmSystem::m_handle;
};

TEST_CASE("MockDcgmSystem::Init")
{
    TestMockDcgmSystem dcgmSystemMock;
...
TEST_CASE("MockDcgmSystem::GetAllDevices")
{
    TestMockDcgmSystem dcgmSystemMock;
