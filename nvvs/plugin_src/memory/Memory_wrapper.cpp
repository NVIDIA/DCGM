    ...
    , m_entityInfo(std::make_unique<dcgmDiagPluginEntityList_v1>())
{
    ...
    m_defaultTestParameters->AddString(PS_RUN_IF_GOM_ENABLED, "True");
    m_defaultTestParameters->AddString(MEMORY_STR_IS_ALLOWED, "False");
    m_defaultTestParameters->AddString(MEMORY_STR_MIN_ALLOCATION_PERCENTAGE,
                                       std::to_string(DEFAULT_MIN_ALLOCATION_PERCENTAGE));
    m_defaultTestParameters->AddDouble(MEMORY_STR_MAX_FREE_MEMORY_MB, 0.0);
    m_defaultTestParameters->AddString(MEMORY_L1TAG_STR_IS_ALLOWED, "False");
    m_defaultTestParameters->AddDouble(MEMORY_L1TAG_STR_TEST_DURATION, 1.0);
    m_defaultTestParameters->AddDouble(MEMORY_L1TAG_STR_TEST_LOOPS, 0);
    m_defaultTestParameters->AddDouble(MEMORY_L1TAG_STR_INNER_ITERATIONS, 1024);
    m_defaultTestParameters->AddDouble(MEMORY_L1TAG_STR_ERROR_LOG_LEN, 8192);
    m_defaultTestParameters->AddString(MEMORY_L1TAG_STR_DUMP_MISCOMPARES, "True");
    m_defaultTestParameters->AddDouble(MEMORY_L1TAG_STR_L1_CACHE_SIZE_KB_PER_SM, 0.0);
    m_defaultTestParameters->AddString(PS_LOGFILE, "stats_memory.json");
