...
case ${TARGET} in
    x86_64-linux-gnu)
        ...
        CUDA12_URL=https://developer.download.nvidia.com/compute/cuda/12.0.0/local_installers/cuda-repo-ubuntu2004-12-0-local_12.0.0-525.60.13-1_amd64.deb
        CUDA12_URL_CHKSUM=1311c6e1b7d78b2e4e6c8cbb694e5d1dcd7609d475be025030a395870954e827fbbefdd0f8b912952328938cf7f1cde3eb2928a072c6a42a00d5a608491ad13c
        ;;
    powerpc64le-linux-gnu)
        ...
        CUDA12_URL=https://developer.download.nvidia.com/compute/cuda/12.0.0/local_installers/cuda-repo-rhel8-12-0-local-12.0.0_525.60.13-1.ppc64le.rpm
        CUDA12_URL_CHKSUM=24c120f9f3a812e1d5565269716b6f197c2827945db5a0a23b56311f273967fcaf9976cd1d7b19f9cbe629b3dbdd2347b366a373a7330b14172e68f87c07de13
        ;;
    aarch64-linux-gnu)
        ...
        CUDA12_URL=https://developer.download.nvidia.com/compute/cuda/12.0.0/local_installers/cuda-repo-ubuntu2004-12-0-local_12.0.0-525.60.13-1_arm64.deb
        CUDA12_URL_CHKSUM=25fa1e25838baffcd262493e82985526e138805de8ffafe6284d91f10bb3573101c6d53b3dea66d80855dd9eb6ddf0feafcf91b008173567b0df175d4b61195a
        ;;
    *)
