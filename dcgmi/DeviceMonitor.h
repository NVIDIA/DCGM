...
private:
    ...
    std::vector<Field_Details> m_fieldDetails; /* Vector or the field details structure for each field. Populated and
                                                  used when list option is mentioned with command.  */
    ...
    std::array<unsigned short, UCHAR_MAX> m_widthArray; /* The array that holds width for each header element in order
                                               of  their occurrence in the output. Max number of width that header can
                                               accommodate is 255. Each value stands for width for next field id in the
                                               horizontal row for each gpu.*/
