...
TEST_CASE("MockCudaDev::UUID")
{
    DcgmNs::MockCudaDev dev;
...
TEST_CASE("MockCudaLib::cuDeviceGetCount")
{
    DcgmNs::MockCudaLib cudaLibMock;
    DcgmNs::MockCudaDev dev1;
    DcgmNs::MockCudaDev dev2;
...
TEST_CASE("MockCudaLib::cuDeviceGet")
{
    DcgmNs::MockCudaLib cudaLibMock;
    DcgmNs::MockCudaDev dev1;
...
TEST_CASE("MockCudaLib::cuDeviceGetUuid_v2")
{
    DcgmNs::MockCudaLib cudaLibMock;
    DcgmNs::MockCudaDev dev1;
    std::string uuid = "GPU-22222222-2222-2222-2222-222222222222";
