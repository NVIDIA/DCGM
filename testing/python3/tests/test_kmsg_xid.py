...
def test_kmsg_fatal_xid_parsing(handle, gpuIds, xid):
    ...
    # suffix.
    gpuPciBusId = gpuAttrib.identifiers.pciBusId[4:-2]
    ...
    try:
        ...
        logger.error("Failed to write {} to /dev/kmsg: {}".format(message, e))
        test_utils.skip_test("Unable to write XID to /dev/kmsg. Skipping test.")
