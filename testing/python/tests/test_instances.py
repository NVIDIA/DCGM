    ...
    if instancesNeeded > 0:
        ...
        for i in range(0, updated.numToCreate):
            if updated.entityList[i].entity.entityGroupId == dcgm_fields.DCGM_FE_GPU_I:
                instanceMap[updated.entityList[i].entity.entityId] = updated.entityList[i].parent.entityId
    ...
    if cisNeeded > 0:
        ...
        for i in range(0, cisNeeded):
            ...
            if instanceIndex > len(legalInstances):
                instanceIndex = 0
            cfe.entityList[cfe.numToCreate].parent.entityId = legalInstances[instanceIndex]
        ...
        for i in range(0, updated.numToCreate):
            if updated.entityList[i].entity.entityGroupId == dcgm_fields.DCGM_FE_GPU_CI:
                ciMap[updated.entityList[i].entity.entityId] = updated.entityList[i].parent.entityId
