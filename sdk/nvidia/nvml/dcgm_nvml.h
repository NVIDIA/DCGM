...
#pragma once
#ifndef __dcgm_nvml_h__
#define __dcgm_nvml_h__

/*
DCGM adoption of the NVML API.

This header aggregates multiple NVML headers to support all drivers that DCGM targets.
Do not use it outside the DCGM codebase or as a direct replacement for nvml.h.
