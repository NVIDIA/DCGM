...
static unsigned int num_buckets(hashtable_t *hashtable)
{
    return primes[hashtable->num_buckets];
}


static pair_t *hashtable_find_pair(hashtable_t *hashtable, bucket_t *bucket, const void *key, unsigned int hash)
{
    list_t *list;
    pair_t *pair;
...
{
    return (long long)(sizeof(*hashtable) + sizeof(hashtable->buckets[0]) * hashtable->num_buckets
                       + sizeof(pair_t) * hashtable->size);
}
